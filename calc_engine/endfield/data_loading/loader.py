...
CHARACTERS_JSON_PATH: str = "calc_engine/endfield/data/characters.json"
"""角色数据 JSON 文件路径"""

WEAPONS_JSON_PATH: str = "calc_engine/endfield/data/weapons.json"
"""武器数据 JSON 文件路径"""

EQUIPMENTS_JSON_PATH: str = "calc_engine/endfield/data/equipments.json"
"""装备数据 JSON 文件路径"""
