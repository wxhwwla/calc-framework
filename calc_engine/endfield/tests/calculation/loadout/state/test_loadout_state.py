...
from calc_engine.endfield.calc.skills.weapon_selection import normalize_weapon_specials_tuple
from games.endfield.gui_design.app.loadout_state import LoadoutState, read_loadout_from_panels
from calc_engine.endfield.tests.conftest import MockSelectionPanel
