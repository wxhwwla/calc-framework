...
from calc_engine.endfield.calc.damage.engine import DamageContext, calculate_single_hit_damage
from calc_engine.endfield.calc.equipment.affix import (
    parse_equipment_affix_line,
)
from calc_engine.endfield.calc.equipment.system import (
    build_runtime_equipment_from_local_record,
)
from calc_engine.endfield.calc.loadout.optimizer import evaluate_task
...
class TestEquipmentAffix(unittest.TestCase):
    ...
    def test_evaluate_task_prefers_war_skill_damage_affix(self):
        ...
        from calc_engine.endfield.calc.loadout.optimizer import WeaponCandidate
