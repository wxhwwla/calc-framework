...
from calc_engine.endfield.calc.core.parallel_evaluate import evaluate_tasks_parallel
from calc_engine.endfield.calc.loadout.optimizer import LoadoutScore, WeaponCandidate
