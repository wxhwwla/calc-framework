...
from calc_engine.endfield.calc.loadout.optimizer import OptimizerConfig, WeaponCandidate, enumerate_optimizer_tasks
...
class TestSearchEstimate(unittest.TestCase):
    ...
    def test_format_workload_estimate_line_mentions_combinations_and_time(self):
        from calc_engine.endfield.calc.search.plan.estimate import SearchDurationEstimate, SearchWorkloadPreview
