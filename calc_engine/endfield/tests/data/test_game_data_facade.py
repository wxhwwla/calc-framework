...
from calc_engine.endfield.data_loading.game_data_facade import GameDataFacade
from calc_engine.endfield.data_loading.loader import DataLoadError
...
class TestGameDataFacade(unittest.TestCase):
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_equipments")
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_weapons", return_value=[{"名称": "剑"}])
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_characters", return_value=[{"名称": "人"}])
    ...
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_equipments", return_value=[])
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_weapons")
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_characters")
    ...
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_equipment_catalog")
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_equipments")
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_weapons", return_value=[])
    @patch("calc_engine.endfield.data_loading.game_data_facade.get_characters", return_value=[])
