...
from calc_engine.endfield.calc.core.result_cache import get_global_result_cache, reset_global_result_cache
from calc_engine.endfield.calc.equipment.system import build_runtime_equipment_from_wiki_draft
...
class TestEnemyParamsExtended(unittest.TestCase):
    ...
    def test_resolve_unknown_id_returns_default(self) -> None:
        with patch("calc_engine.endfield.data_loading.enemy_params.get_plugin_registry", return_value=PluginRegistry()):
