...
from calc_engine.endfield.calc.damage.engine import CritMode, DamageContext, calculate_single_hit_damage
from calc_engine.endfield.calc.equipment.affix import aggregate_loadout_modifiers
from calc_engine.endfield.calc.equipment.prune import character_ability_attrs
from calc_engine.endfield.calc.equipment.system import build_four_slot_loadout, collect_loadout_effects
...
from calc_engine.endfield.calc.search.evaluate.context import SearchEvalContext
...
def _resolve_skill_counts(
    ...
    if config.skill_counts is not None:
        from calc_engine.endfield.calc.skills.segments import normalize_manual_segment_counts
