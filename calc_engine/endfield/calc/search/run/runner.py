...
from calc_engine.endfield.calc.loadout.optimizer import LoadoutScore, OptimizerConfig, OptimizerTask, WeaponCandidate
    ...
    def run_with_engine(
        ...
        *,
        ...
        示例::
            ...
            from calc_engine.endfield.calc.search.adapter import EndfieldSearchEngine
