...
def compute_attr_weapon_bonus(
    *,
    ...
    sa1_name: str, sa1_level: int,
    sa2_name: str, sa2_level: int,
    sa3_name: str, sa3_level: int,
    ws_name: str, ws_level: int, ws_stack: int,
    ws2_name: str, ws2_level: int, ws2_stack: int,
    main_attr: str, sub_attr: str,
    trust_level: int,
) -> tuple[float, float]:
    flat_bonus = 0.0
    pct_bonus = 0.0
    ...
    md, sd = add_special_picks_to_main_sub_bonus(
        weapon,
        ws_name=ws_name, ws_level=ws_level, ws_stack=ws_stack,
        ws2_name=ws2_name, ws2_level=ws2_level, ws2_stack=ws2_stack,
