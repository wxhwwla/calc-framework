...
if TYPE_CHECKING:
    from calc_engine.endfield.calc.multiplicative_zones.zone_snapshot import MultiplicativeZoneSelection
...
from calc_engine.endfield.calc.multiplicative_zones import ZoneDisplayLine
...
def _generate_dag_json() -> None:
    from calc_engine.endfield.calc.multiplicative_zones.dag.config import generate, save_dag
