...
from calc_engine.endfield.calc.equipment.system import FourSlotLoadout, _infer_damage_types, _parse_percent_value
...
def parse_equipment_affix_line(
    ...
    *,
    ...
    skill_match = _SKILL_BONUS_RE.search(raw.replace(" ", ""))
    if skill_match:
    ...
    dmg_match = _DAMAGE_BONUS_RE.search(raw.replace(" ", ""))
