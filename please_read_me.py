...
# - 更新文档 CONTEXT.md
# - 修改 calc_engine/endfield/calc/dag_adapter/__init__.py
# - 修改 calc_engine/endfield/calc/dag_adapter/__main__.py
# - 修改 calc_engine/endfield/calc/dag_adapter/_subgraph_builders.py
# - 修改 calc_engine/endfield/calc/dag_adapter/adapter.py
# - 修改 calc_engine/endfield/calc/dag_adapter/config.py
# - 修改 calc_engine/endfield/calc/dag_adapter/loader.py
...
# - 修改 calc_engine/endfield/calc/zone_snapshot/__init__.py
# - 修改 calc_engine/endfield/calc/zone_snapshot/compute.py
# - 修改 calc_engine/endfield/calc/zone_snapshot/types.py
...
# - 更新文档 docs/adr/0020-multiplicative-zones-decouple.md
