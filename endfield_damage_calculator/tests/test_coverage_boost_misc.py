...
from calculation.result_cache import get_global_result_cache, reset_global_result_cache
...
class TestEnemyParamsExtended(unittest.TestCase):
    def test_list_choices_includes_default_and_plugins(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("data.enemy_params.get_plugin_registry", return_value=reg):
    ...
    def test_resolve_unknown_id_returns_default(self) -> None:
        with patch("data.enemy_params.get_plugin_registry", return_value=PluginRegistry()):
