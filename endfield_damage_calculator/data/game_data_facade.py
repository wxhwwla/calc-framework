...
from data.loader import DataLoadError, get_characters, get_equipments, get_weapons
...
class GameDataFacade:
    ...
    load_error: Optional[DataLoadError] = None
    equipment_load_error: Optional[DataLoadError] = None
    ...
    def catalog_search_error(self, scope_label: str = "全部装备") -> Optional[str]:
        """全量遍历不可用时的错误文案；可用时返回 None。"""
        return catalog_full_search_error(self.equipment_catalog(scope_label))

    def catalog_status(self, scope_label: str = "全部装备") -> Optional[str]:
    ...
    def reload_equipment_rows(self) -> None:
        ...
        from data.loader import reload_equipments
