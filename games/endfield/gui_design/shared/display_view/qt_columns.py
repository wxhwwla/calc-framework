...
from calc_engine.endfield.calc.multiplicative_zones.zone_snapshot import ZoneDisplayLine
...
class QtAttributeColumns(QWidget):
    ...
    def _build_zone_lines(self, request: DisplayRequest) -> list[ZoneDisplayLine]:
        ...
        from calc_engine.endfield.calc.core.preview_cache import sync_confirm_dependencies
        ...
        if mode == "single_hit":
            from gui_design.presentation.display_lines import build_single_hit_damage_lines
