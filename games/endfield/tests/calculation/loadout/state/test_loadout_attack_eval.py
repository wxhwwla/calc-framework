...
class TestLoadoutAttackEval(unittest.TestCase):
    ...
    def test_build_run_signature_includes_weapon_skill_levels(self) -> None:
        ...
        sig_a = build_run_signature(**base_kwargs, weapon_normal_levels=[], weapon_special_states=[])  # type: ignore[arg-type]

        sig_b = build_run_signature(**base_kwargs, weapon_normal_levels=[9], weapon_special_states=[])  # type: ignore[arg-type]
