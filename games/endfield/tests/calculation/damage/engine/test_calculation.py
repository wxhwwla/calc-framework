...
class TestInverseCalculations(unittest.TestCase):
    ...
    def test_fit_skill_formula(self):
        ...
        base, _growth, _divisor, _offset, special = fit_skill_formula(data)
    ...
    def test_fit_skill_formula_no_special(self):
        ...
        base, _growth, _divisor, _offset, _special = fit_skill_formula_no_special(data)
    ...
    def test_fit_formula_auto_detect(self):
        ...
        _base, _growth, _divisor, _offset, special = fit_formula(attr_data)
        ...
        _base, _growth, _divisor, _offset, special = fit_formula(skill_data)
