...
class TestInverseRefactored(unittest.TestCase):
    ...
    def test_fit_attribute_formula_integer(self):
        ...
        base, _growth, _divisor, _offset = fit_attribute_formula(data)
    ...
    def test_fit_skill_formula_no_special_integer(self):
        ...
        base, _growth, _divisor, _offset, special = fit_skill_formula_no_special(data)
    ...
    def test_fit_formula_auto_detect(self):
        ...
        base, _growth, _divisor, _offset, _special = fit_formula(int_data)
        ...
        base, _growth, _divisor, _offset, _special = fit_formula(float_data)
