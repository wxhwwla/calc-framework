...
_PKG_ROOT = _REPO_ROOT / "games" / "endfield" / "calc"
...
PARTICIPANTS_JSON = (
    _REPO_ROOT / "games" / "endfield" / "data" / "characters.json"
)
WEAPONS_JSON = (
    _REPO_ROOT / "games" / "endfield" / "data" / "weapons.json"
)
...
def _minimal_context() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "weapon": {
            ...
            "精炼等级": 1, "法术伤害+": 0.0, "攻击力+平值": 0.0, "最大生命值+": 0.0,
        ...
        "computed": {
            ...
            "武器精炼主能力值加成": 0.0, "武器精炼附加攻击力加成": 0.0,
...
class TestEndfieldDAGIntegration:
    ...
    def generated_dag(self):
        ...
        from games.endfield.calc.dag_adapter.config import OUTPUT_PATH, generate
    ...
    def adapter_pkg(self, generated_dag):
        ...
        from games.endfield.calc.dag_adapter.config import save_dag
    ...
    def test_single_hit_damage_parity(self, adapter_pkg):
        ...
        from games.endfield.calc.damage.engine.calculate import calculate_single_hit_damage
