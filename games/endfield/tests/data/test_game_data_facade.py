...
class TestGameDataFacade(unittest.TestCase):
    @patch("data.game_data_facade.get_equipments")
    @patch("data.game_data_facade.get_weapons", return_value=[{"名称": "剑"}])
    @patch("data.game_data_facade.get_characters", return_value=[{"名称": "人"}])
    ...
    @patch("data.game_data_facade.get_equipment_catalog")
    @patch("data.game_data_facade.get_equipments")
    @patch("data.game_data_facade.get_weapons", return_value=[])
    @patch("data.game_data_facade.get_characters", return_value=[])
