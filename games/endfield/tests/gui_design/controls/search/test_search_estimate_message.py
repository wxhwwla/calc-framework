...
class TestComposeSearchEstimateMessage:
    ...
    def test_no_char(self) -> None:
        ...
        msg = compose_search_estimate_message(
            ...
            has_char=False, has_weapon=True,

            catalog_err=None, weapons_empty=False,

            job_error=None, estimate_text=None,
    ...
    def test_no_weapon(self) -> None:
        ...
        msg = compose_search_estimate_message(
            ...
            has_char=True, has_weapon=False,
    ...
    def test_catalog_err(self) -> None:
        ...
        msg = compose_search_estimate_message(
            ...
            has_char=True, has_weapon=True,

            catalog_err="装备目录加载失败。请检查数据文件。",

            weapons_empty=False, job_error=None,
    ...
    def test_weapons_empty(self) -> None:
        ...
        msg = compose_search_estimate_message(
            ...
            catalog_err=None, weapons_empty=True,
