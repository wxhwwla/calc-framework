...
class TestCheckUpdate:
    ...
    @patch("utils.updater.urlopen")
    def test_rejects_http_download(self, mock_urlopen: MagicMock) -> None:
        info = UpdateInfo(
            latest_version="0.7.0-beta",
    ...
    @patch("utils.updater.urlopen")
    def test_prefers_launcher_asset(self, mock_urlopen: MagicMock) -> None:
        data = {
            "tag_name": "v0.7.0-beta",
            "body": "",
            "assets": [
                ...
                {
                    "name": "GameCalcPlatform_v0.7.0-beta.zip",
                    "size": 2,
        ...
        info = check_update("0.6.0-beta")
        assert info is not None
        assert info.asset_name == "GameCalcPlatform_v0.7.0-beta.zip"
