...
class TestFpsAdapter:
    ...
    def test_mid_range_linear_decay(self, fps_svc):
        ctx = self._ctx(
            **{"weapon.decay_start": 10, "weapon.decay_end": 30, "weapon.min_damage_ratio": 0.4, "enemy.distance": 20}
        )  # noqa: E501
