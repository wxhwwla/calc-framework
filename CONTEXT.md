...
| **计算与搜索列** | GUI 第 2 列（`APP_COLUMN_WEIGHTS` 索引 2）：单段伤害、全量遍历、并行线程、预估与状态 |
| **右侧乘区** | GUI 第 5 列，展示 15 乘区链（防御、能力、最终攻击力等） |
| **角色属性列** | GUI 第 3 列，角色曲线与技能倍率 |
| **武器属性列** | GUI 第 4 列，武器攻击与附加属性 |
| **主界面列权重** | `(0, 0, 1, 1, 1, 5)`：0–1 选择区固定宽，2–4 可伸缩，5 乘区主伸缩 |
