...
if TYPE_CHECKING:
    from adapters.endfield.calc.multiplicative_zones.zone_snapshot import MultiplicativeZoneSelection
...
from adapters.endfield.calc.multiplicative_zones import ZoneDisplayLine
...
def _generate_dag_json() -> None:
    from adapters.endfield.calc.multiplicative_zones.dag.config import generate, save_dag
