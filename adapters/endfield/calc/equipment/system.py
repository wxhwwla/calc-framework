...
from adapters.endfield.calc.damage.engine import DamageEffect
from adapters.endfield.calc.damage.types import infer_equipment_damage_types
...
def _parse_effect_text(text: str, *, source: str) -> DamageEffect:
    from adapters.endfield.calc.equipment.affix import parse_equipment_affix_line
