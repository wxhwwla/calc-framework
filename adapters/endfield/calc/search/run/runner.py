...
from adapters.endfield.calc.loadout.optimizer import LoadoutScore, OptimizerConfig, OptimizerTask, WeaponCandidate
    ...
    def run_with_engine(
        ...
        *,
        ...
        示例::
            ...
            from adapters.endfield.calc.search.adapter import EndfieldSearchEngine
