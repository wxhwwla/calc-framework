...
from adapters.endfield.calc.damage.inverse import _is_decimal_data, fit_skill_formula_no_special
...
class TestScalingMode(unittest.TestCase):
    ...
    def test_fit_integer_weapon_bonus_rebuilds_with_integer_floor(self):
        from adapters.endfield.calc.damage.formula import calculate_bonus_attribute
