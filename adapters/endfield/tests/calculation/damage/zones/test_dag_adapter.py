...
class TestDAGAdapter(unittest.TestCase):
    ...
    def test_dag_adapter_imports(self):
        from adapters.endfield.calc.multiplicative_zones.dag.adapter import (
            build_dag_context,
    ...
    def test_build_dag_context_returns_all_required_keys(self):
        from adapters.endfield.calc.multiplicative_zones.dag.adapter import build_dag_context
    ...
    def test_evaluate_attack_chain_via_dag_matches_existing_engine(self):
        ...
        from adapters.endfield.calc.multiplicative_zones.dag.adapter import evaluate_attack_chain_via_dag
    ...
    def test_dag_adapted_snapshot_matches_existing_snapshot(self):
        from adapters.endfield.calc.multiplicative_zones.dag.adapter import compute_snapshot_with_dag
