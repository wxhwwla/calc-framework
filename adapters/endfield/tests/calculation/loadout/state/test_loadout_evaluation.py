...
class TestLoadoutEvaluation(unittest.TestCase):
    ...
    @patch("games.endfield.gui_design.app.loadout_evaluation.build_damage_snapshot")
    @patch("games.endfield.gui_design.app.loadout_evaluation.sync_evaluation_cache")
    ...
    @patch("games.endfield.gui_design.app.loadout_evaluation.build_single_skill_search_preview_lines")
    @patch("games.endfield.gui_design.app.loadout_evaluation.sync_evaluation_cache")
