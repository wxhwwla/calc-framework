...
from adapters.endfield.calc.manual_buff.physical import evaluate_physical_abnormal_total
from adapters.endfield.calc.manual_buff.spell import evaluate_spell_abnormal_total
