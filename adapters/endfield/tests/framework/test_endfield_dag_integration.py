...
class TestEndfieldDAGIntegration:
    ...
    def generated_dag(self):
        from adapters.endfield.calc.multiplicative_zones.dag.config import OUTPUT_PATH, generate
    ...
    def adapter_pkg(self, generated_dag):
        from adapters.endfield.calc.multiplicative_zones.dag.config import save_dag
    ...
    @pytest.fixture(scope="class")
    def context(self):
        from adapters.endfield.calc.multiplicative_zones.dag.loader import EndfieldContextLoader
    ...
    def test_final_attack_parity(self, adapter_pkg):
        ...
        from adapters.endfield.calc.multiplicative_zones.final_attack_zone import (
    ...
    def test_single_hit_damage_parity(self, adapter_pkg):
        from adapters.endfield.calc.damage.engine.calculate import calculate_single_hit_damage
        from adapters.endfield.calc.damage.engine.types import DamageContext
