...
from adapters.endfield.calc.core.preview_cache import cached_preview, sync_confirm_dependencies
from adapters.endfield.calc.core.result_cache import get_global_result_cache, reset_global_result_cache
...
from adapters.endfield.data_loading.plugin_registry import PluginRegistry
...
class TestEnemyParamsExtended(unittest.TestCase):
    def test_list_choices_includes_default_and_plugins(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("adapters.endfield.data_loading.enemy_params.get_plugin_registry", return_value=reg):
    ...
    def test_resolve_unknown_id_returns_default(self) -> None:
        with patch("adapters.endfield.data_loading.enemy_params.get_plugin_registry", return_value=PluginRegistry()):
