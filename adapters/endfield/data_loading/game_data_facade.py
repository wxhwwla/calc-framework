...
from adapters.endfield.data_loading.equipment_catalog import (
    catalog_full_search_error,
    catalog_preview_status_lines,
    catalog_status_message,
    get_equipment_catalog,
)
from adapters.endfield.data_loading.loader import DataLoadError, get_characters, get_equipments, get_weapons
...
class GameDataFacade:
    ...
    def reload_equipment_rows(self) -> None:
        ...
        from adapters.endfield.data_loading.loader import reload_equipments
